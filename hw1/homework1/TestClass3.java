...
/**
 *
 * This class is TestClass3 class.
 *
 */
...
{
    /**
     * Default constructor for creating TestClass3 objects without parameters.
     */
    public TestClass3(){}
    ...
    */
    public static void main(String[] args)
    {
        ...
        account[0] = new Account(1, "gizemsungu", "13.01.1993", "Antalya");
        System.out.println("   An acoount with username sibelgulmez has been created.");
        account[1] = new Account(2, "sibelgulmez", "10.03.1995", "Istanbul");
        System.out.println("   An acoount with username gokhankaya has been created.");
        account[2] = new Account(3, "gokhankaya", "10.23.1984", "Erzincan");
        System.out.println("\n");
        
        System.out.println("2)  Logging into an account (username: sibelgulmez) ...");
        account[1].Login(account, 3);
        System.out.println("\n");
        
        System.out.println("3)  Sharing two posts...\n");
        account[1].SharePost("BESIKTAS");
        account[1].SharePost("LOVE");
        System.out.println("4)  Following gizemsungu and gokhankaya\n\n");
        account[1].FollowPerson(account[2]);
        account[1].FollowPerson(account[0]);
        ...
        account[0].Login(account, 3);
        account[0].CheckingOutbox();
        account[0].CheckingInbox();
        account[0].ViewingOutbox(account, 3);
        account[0].ViewingInbox(account, 3);
        System.out.println("18)  Viewing sibelgulmez's profile...\n");
        account[0].ViewProfile(account[1]);
        System.out.println("19)  Viewing sibelgulmez's posts...\n");
        account[0].ViewingPosts(account[1]);
        System.out.println("20)  Viewing sibelgulmez's posts' interactions...\n");
        account[0].ViewingPostInteractions(account[1], account, 3);
        System.out.println("21)  Liking sibelgulmez's posts...\n");
        account[0].LikePost(account[1], 0);
        account[0].LikePost(account[1], 1);
        ...
        account[0].SharePost("This homework is too easy...");
        account[0].SharePost("I am sure that this homework is so nice..");
        ...
        account[1].ViewingPostInteractions(account[0], account, 3);
        ...
        account[0].ViewProfile(account[0]);
        ...
        account[0].Logout();
        System.out.println("49)  Logging into account of 'gizemsungu'\n");
        account[0].Login(account, 3);
        System.out.println("50)  Block 'sibelgulmez'...\n");
        account[0].BlockUsers("sibelgulmez");
        System.out.println("51)  Logging out from account of 'gizemsungu'\n");
        account[0].Logout();
        System.out.println("52)  Logging into account of 'sibelgulmez'\n");
        account[1].Login(account, 3);
        System.out.println("53)  Try to enter view the profile of 'gizemsungu'\n");
        account[1].ViewProfile(account[0]);
        System.out.println("54)  Try to send message to 'gizemsungu'\n");
        account[1].SendMessage(account[0], "I m sorry to block you...");
        System.out.println("55)  Try to logging to another account..");
        account[2].Login(account, 3);
        System.out.println("56)  Logging out from account of 'sibelgulmez'\n");
        account[1].Logout();
    }
}
