...
public class Account 
{
	...
	private ArrayList<String> 	 		blockUsers;
    ...
    *
    */
	public void Login(ArrayList<Account> people, int index)
	{
       int flagControl = 0;
    ...
    *
    */
	public void ViewingPostInteractions(Account person, ArrayList<Account> people, int numberPeople)
	{
		if (control == true)
		{
           if (this.isBlocked(person) == false)
    ...
    *
    */
	public void ViewingOutbox(ArrayList<Account> people, int index)
	{
		if (control == true)
		{
    ...
    *
    */
	public void ViewingInbox(ArrayList<Account> people, int index)
	{
		if (control == true)
		{
