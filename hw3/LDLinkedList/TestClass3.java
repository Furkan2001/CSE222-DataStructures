...
public class TestClass3
{
   ...
   */
   public static void main(String[] args)
   {
       ...
       account.get(1).ViewingPosts(account.get(0));
       System.out.println("34)  Views the interaction of posts of 'gizemsungu'\n");
       ...
       account.get(0).BlockUsers(account.get(1));
       ...
       account.get(1).SendMessage(account.get(0), "I m sorry to block you...");
