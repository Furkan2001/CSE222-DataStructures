...
public class Account 
{
	...
	private LinkedList<String> 	 		blockUsers;
    ...
    */
	public Account(int id, String name, String birth, String place)
	{
		...
		this.blockUsers = new LinkedList<>();
    ...
    *
    */
	public void Login(LinkedList<Account> people, int index)
	{
       int flagControl = 0;
    ...
    *
    */
	public void ViewingPostInteractions(Account person, LinkedList<Account> people, int numberPeople)
	{
		if (control == true)
		{
           if (this.isBlocked(person) == false)
    ...
    *
    */
	public void ViewingOutbox(LinkedList<Account> people, int index)
	{
		if (control == true)
		{
    ...
    *
    */
	public void ViewingInbox(LinkedList<Account> people, int index)
	{
		if (control == true)
		{
